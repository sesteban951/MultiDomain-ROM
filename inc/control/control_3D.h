...
#include "../dynamics/dynamics_3D.h"
...
class Controller
{
    ...
    private:
        ...
        // Monte Carlo results
        Solution_Bundle S_mc;        // solution bundle
        Vector_6d_Traj_Bundle U_mc;  // sampled input trajectories
        Vector_1d_List J_mc;         // solution bundle

        // Receding Horizon results
        Solution_Bundle S_elite;        // solution bundle
        Vector_6d_Traj_Bundle U_elite;  // sampled input trajectories
        Vector_1d_List J_elite;         // solution bundle
};
